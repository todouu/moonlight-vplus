...
public class DigitalStick extends Element {
    ...
    private String boostKey = "k59";  // 按键摇杆默认左Shift
    ...
    public DigitalStick(Map<String, Object> attributesMap,
        ...
        if (extraAttrObj instanceof String && !((String) extraAttrObj).isEmpty()) {
            try {
                ...
                LimeLog.warning("DigitalStick: failed to parse extra_attributes: " + e);
            }
        }
    ...
    protected SuperPageLayout getInfoPage() {
        ...
        NumberSeekbar boostThresholdSeekbar = digitalStickPage.findViewById(R.id.page_digital_stick_boost_threshold);
        TextView boostKeyTextView = digitalStickPage.findViewById(R.id.page_digital_stick_boost_key);
